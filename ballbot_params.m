...
% The radius of the ring is set to 0.282, such that when the leg is 0.05m
% from ground. Legs will contact with ground at 5 degree tilt.
h_ring = 0.114;     % Ring distance from ground [m]

k_leg = 100;        % Leg Stiffness [N/m] 
